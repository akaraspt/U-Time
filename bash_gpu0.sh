...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../isruc1_c4-a1_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../isruc1_f4-a1_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../isruc1_o2-a1_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../mass_ss1_c4_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../mass_ss1_f4_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../mass_ss1_o2_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../mass_ss1_pz_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../mass_ss3_c4_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../mass_ss3_f4_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../mass_ss3_o2_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../mass_ss3_pz_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C3-A2 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../shhs1_normal_c3-a2_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../shhs1_normal_c4-a1_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-CLE --alt_channels C4-LER --initialize_from ../shhs1_normal_c4-a1_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../shhs1_osa_c3-a2_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-A1 --initialize_from ../shhs1_osa_c4-a1_project/model/model_weights.h5 --overwrite
cd ..
...
ut train --num_gpus=1 --force_gpu=0 --channels C4-CLE --alt_channels C4-LER --initialize_from ../shhs1_osa_c4-a1_project/model/model_weights.h5 --overwrite
cd ..
