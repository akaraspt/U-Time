...
# Split
ut cv_split --data_dir './processed/shhs1_nor/' --subject_dir_pattern 'shhs1-*' --CV 1 --validation_fraction 0.10 --max_validation_subjects 100 --test_fraction 0.10 --max_test_subjects 100 --overwrite

# Initialize a U-Time project
ut init --name shhs1_nor_project \
        --model utime \
        --data_dir processed/shhs1_nor/views/fixed_split \
        --overwrite

# Train
cd shhs1_nor_project
