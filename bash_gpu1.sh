...
# ut train --num_gpus=1 --force_gpu=1 --channels C4-A1 --overwrite
# cd ..
...
# ut train --num_gpus=1 --force_gpu=1 --channels Fpz-Cz --initialize_from ../shhs1_normal_c4-a1_project/model/model_weights.h5 --overwrite
# cd ..
...
# ut train --num_gpus=1 --force_gpu=1 --channels F4-A1 --initialize_from ../shhs1_normal_c4-a1_project/model/model_weights.h5 --overwrite
# cd ..
...
# ut train --num_gpus=1 --force_gpu=1 --channels F4-CLE --alt_channels F4-LER --initialize_from ../shhs1_normal_c4-a1_project/model/model_weights.h5 --overwrite
# cd ..
...
# ut train --num_gpus=1 --force_gpu=1 --channels Fpz-Cz --initialize_from ../shhs1_osa_c4-a1_project/model/model_weights.h5 --overwrite
# cd ..
...
# ut train --num_gpus=1 --force_gpu=1 --channels F4-A1 --initialize_from ../shhs1_osa_c4-a1_project/model/model_weights.h5 --overwrite
# cd ..
...
# ut train --num_gpus=1 --force_gpu=1 --channels F4-CLE --alt_channels F4-LER --initialize_from ../shhs1_osa_c4-a1_project/model/model_weights.h5 --overwrite
# cd ..
...
# ut train --num_gpus=1 --force_gpu=1 --channels C4-A1 --initialize_from ../sleepedf_fpz-cz_project/model/model_weights.h5 --overwrite
# cd ..
...
# ut init --name sleepedf_pz-oz_project --model utime --data_dir ./processed/sedf_sc/views/fixed_split
# cd sleepedf_pz-oz_project
# ut train --num_gpus=1 --force_gpu=1 --channels Pz-Oz --overwrite
# cd ..
...
ut train --num_gpus=1 --force_gpu=1 --channels C4-A1 --initialize_from ../sleepedf_pz-oz_project/model/model_weights.h5 --overwrite
cd ..
